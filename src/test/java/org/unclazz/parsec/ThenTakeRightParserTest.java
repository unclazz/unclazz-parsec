...
public class ThenTakeRightParserTest {

	@Test
	public void testParseString() {
		final ValParser<String> p_0_1 = Parsers.exact('0').then(Parsers.exact('1').val());
		final ValParser<String> p_0_cut_1 = Parsers.exact('0').cut().then(Parsers.exact('1').val());
		...
		assertThat(p_0_1_r_012.value(), is("1"));
		...
		assertThat(p_0_cut_1_r_012.value(), is("1"));
